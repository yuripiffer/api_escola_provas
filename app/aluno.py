...
def matricular_aluno():
    ...
    - nome
    - data de nascimento
    é cadastrado no banco de alunos e recebe uma matrícula

    gera e persiste o id_aluno (auto increment)
...
def listar_provas(id_aluno):
    ...
    - id_prova
    - titulo_prova
    Caso não haja nenhuma prova cadastrava, retorna um dict vazio

    :param id_aluno: int
    :return:dict com provas já cadastradas
    """
    pass

def questoes_e_alternativas(id_aluno, id_prova):
    """
...
def realizar_prova(id_aluno, id_prova):
    """
